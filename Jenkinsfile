pipeline {
    ...
    parameters {
        choice(name: 'DEPLOYMENT_FILE', choices: ['kubernetes/kube-catalogo-landing.yaml', 'kubernetes/kube-ecommerce-ms.yaml', 'kubernetes/kube-vtol-manager-carsa-prd.yaml', 'kubernetes/kube-jenkinsk8s.yaml'], description: 'Ruta al archivo de despliegue Kubernetes dentro del repositorio')
